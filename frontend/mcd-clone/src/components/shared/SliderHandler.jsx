...
import { useBannerHandler } from '@/store';

export const SliderHandler = () => {

  const { currentBanner, setBanner, showNextBanner, showPrevBanner } = useBannerHandler();
  ...
  return (
    <div className='flex flex-row gap-5 items-center'>
        ...
        onClick={() => setBanner(5)} />
        <BannerDot isActive={ currentBanner === 6 ? true : false } 
        onClick={() => setBanner(6)} />
